...
フォームに加工条件（機械・ワーク種別・内径スタイル・寸法など）を入力すると、**NC旋盤向けのGコード（工作機械への命令文）を自動生成する** Web アプリです。画面は一問一答形式のウィザードで、対応機械は NCL044 / NCL015 / NCL085 / NCL012 / CL-25-2 / CL-25-1（`assets/data-v2.js` の `machines` に定義された機種を UI がそのまま表示）。
...
| ファイル | 役割 |
|---|---|
| `data-v2.js` | 機械定義（NCL044/NCL015/NCL085/NCL012/CL-25-2/CL-25-1 の Mコード・工具オフセット）とチューブ規格データ・ワーク種別レジストリ |
