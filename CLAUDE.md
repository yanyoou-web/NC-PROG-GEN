...
- フォームに加工条件（機械・ワーク種別・寸法など）を入力すると、**NC旋盤向けのGコード（工作機械への命令文）を自動生成する** Web アプリ。生成された Gコードは NC旋盤（NCL044/NCL015/NCL085/NCL012/CL-25-2/CL-25-1 の6機種、`assets/data-v2.js` に定義）に直接送り込んで使用する。
