...
const appSrc = readFileSync(join(ROOT, "NC-PROG-GEN", "assets", "logic-v2.js"), "utf8");
...
const dataSrc = readFileSync(join(ROOT, "NC-PROG-GEN", "assets", "data-v2.js"), "utf8");
...
// ─── 全テンプレートのプレースホルダーを抽出 ─────────────────────────────────
const templateDir = join(ROOT, "NC-PROG-GEN", "テンプレート");
